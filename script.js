...
async function getUsers() {
  const res = await fetch("https://682815d76b7628c529122082.mockapi.io/users");
...
async function deleteUser(id) {
  try {
    const res = await fetch(
      "https://682815d76b7628c529122082.mockapi.io/users/" + id,
      {
        method: "DELETE",
      }
    );
...
async function editUser(odam) {
    ...
    saveBtn.addEventListener("click",async()=>{
      const res=await fetch("https://682815d76b7628c529122082.mockapi.io/users/"+odam.id,{
        method:"PUT",
        headers:{
          "Content-type":"application/json"
        },
